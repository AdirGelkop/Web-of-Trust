...
├── sim-lab/                 # Phase 1 (structure in §7.3)
...
- [ ] **Phase 0.2** — Lock decisions D1–D6 into `docs/decisions.md`; translate open questions into hypotheses H1–H8
- [ ] **Phase 1.1** — Repo scaffold + graph generators + SNAP loaders
- [ ] **Phase 1.2** — PPR + TrustRank implementations, unit-tested
